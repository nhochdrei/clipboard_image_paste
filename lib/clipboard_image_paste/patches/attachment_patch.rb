...
# - Jonas Stoehr: fixing this in tears
#
# Terms of use:
...
unless Issue.included_modules.include? ClipboardImagePaste::Patches::AttachmentPatch
  Issue.send(:include, ClipboardImagePaste::Patches::AttachmentPatch)
end

unless News.included_modules.include? ClipboardImagePaste::Patches::AttachmentPatch
  News.send(:include, ClipboardImagePaste::Patches::AttachmentPatch)
end

unless WikiPage.included_modules.include? ClipboardImagePaste::Patches::AttachmentPatch
  WikiPage.send(:include, ClipboardImagePaste::Patches::AttachmentPatch)
end

unless Message.included_modules.include? ClipboardImagePaste::Patches::AttachmentPatch
  Message.send(:include, ClipboardImagePaste::Patches::AttachmentPatch)
end

unless Document.included_modules.include? ClipboardImagePaste::Patches::AttachmentPatch
  Document.send(:include, ClipboardImagePaste::Patches::AttachmentPatch)
end

unless Version.included_modules.include? ClipboardImagePaste::Patches::AttachmentPatch
  Version.send(:include, ClipboardImagePaste::Patches::AttachmentPatch)
end

unless Project.included_modules.include? ClipboardImagePaste::Patches::AttachmentPatch
  Project.send(:include, ClipboardImagePaste::Patches::AttachmentPatch)
end

# KbArticle plug-in (https://github.com/alexbevi/redmine_knowledgebase)
begin
  unless KbArticle.included_modules.include? ClipboardImagePaste::Patches::AttachmentPatch
    KbArticle.send(:include, ClipboardImagePaste::Patches::AttachmentPatch)
  end
rescue NameError => e
